...
router.get('/', authenticate, authorize(['expenseCategory:read', 'expenses:read', 'expenses:view']), listCategories);
router.get('/:id', authenticate, authorize(['expenseCategory:read', 'expenses:read', 'expenses:view']), getCategory);
